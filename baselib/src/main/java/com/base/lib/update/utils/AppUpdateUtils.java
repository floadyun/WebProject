package com.base.lib.update.utils;
...
import com.base.lib.update.listener.ExceptionHandlerHelper;
...
//        onSmartInstall(appFile,activity);return true;
        try {
     ...
     * 智能安装
     */
    public static void onSmartInstall(File apkFile,Activity context) {
        try{
            Uri uri = null;
     ...
     * @return
     */
    public static boolean isUpVersion(String serviceVersion,Context context){
        return serviceVersion.equals(getVersionName(context));
    }
}
