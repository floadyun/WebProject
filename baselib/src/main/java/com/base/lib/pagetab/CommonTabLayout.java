...
import com.base.lib.pagetab.listener.CustomTabEntity;
import com.base.lib.pagetab.listener.OnTabSelectListener;
import com.base.lib.pagetab.utils.FragmentChangeManager;
import com.base.lib.pagetab.utils.UnreadMsgUtils;
import com.base.lib.pagetab.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mUnderlineColor = ta.getColor(R.styleable.CommonTabLayout_tl_underline_color, Color.parseColor("#eeeeee"));
        ...
        mDividerColor = ta.getColor(R.styleable.CommonTabLayout_tl_divider_color, Color.parseColor("#eeeeee"));
        ...
        mTextsize = ta.getDimension(R.styleable.CommonTabLayout_tl_textsize, sp2px(14f));
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.LEFT) {
                ...
                tabView = View.inflate(mContext,R.layout.layout_tab_custom, null);
            }
            tabView.setTag(i);
            addTab(i, tabView);
        }
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setTabStatus(int tab,int visible){
        View tabView = mTabsContainer.getChildAt(tab);
        TextView statuText = tabView.findViewById(R.id.tab_tatus_text);
        statuText.setVisibility(visible);
    }
