...
//     * @return
//     */
//    public static boolean judgeDecimalPoint(String temp){
//        //等于0表示字符全部为小数点
...
//     * @return
//     */
//    public static int judgeNumber( Editable edt) {
...
//    /**
//     * EditText中输入的内容不能小于一位数字切不能以"0"，"00"，"."开头
//     * @param edt
//     * @return
//     */
//    /**
//     *
//     * @param isNumberDecimal ture小数，false整数
//     * @param edt
//     * @return
//     */
//    public static boolean judgeNoLessThanZeroNumber(boolean isNumberDecimal,Editable edt) {
//        String temp = edt.toString();
...
//            }else if(length==2){
////                if(isNumberDecimal){
////                    String strChar=temp.substring(1,2);
////                    if(!TextUtils.equals(".",strChar)){
////                        edt.delete(1,2);
////                        return false;
////                    }
////                }
//                if(TextUtils.equals("00",temp)){
//                    edt.delete(1,2);
//                    return false;
//                }
//            }
//            if (posDot <= 0) {//不包含小数点
//                if (length <= 7) {
//                    edt.delete(7, 7 + 1);//大于frontInteger位数就删掉第frontInteger+1位（只会保留frontInteger位）
//                }
//            }else{
//                if(isNumberDecimal){
//                    if (temp.length() - posDot - 1 > 2)//如果包含小数点,保留两位
//                    {
//                        edt.delete(posDot + 3, posDot + 4);//删除小数点后的第三位
//                        return false;
//                    }
