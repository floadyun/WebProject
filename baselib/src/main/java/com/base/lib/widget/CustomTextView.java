...
public class CustomTextView extends AppCompatTextView {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        strokeColor = ta.getInteger(R.styleable.CustomTextView_textStrokeColor, 0x00000000);

        solidTouchColor = ta.getInteger(R.styleable.CustomTextView_solidTouchColor, 0x00000000);
        strokeTouchColor = ta.getInteger(R.styleable.CustomTextView_strokeTouchColor, 0x00000000);
        textTouchColor= ta.getInteger(R.styleable.CustomTextView_textTouchColor, 0x00000000);
        textColor=getCurrentTextColor();
        strokeWith = ta.getInteger(R.styleable.CustomTextView_strokeWith, 0);
