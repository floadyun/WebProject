...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mMaxColumns = a.getInt(R.styleable.FlowLayout_flMaxColumns,DEFAULT_MAX_COLUMNS);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if(mMaxColumns>0){
                childWidth = widthSize/mMaxColumns;
                child.setLayoutParams(new LayoutParams(childWidth,LayoutParams.WRAP_CONTENT));
            }
